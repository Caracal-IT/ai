...
15. Update the `docs/index.md` with a tree view of the implementation path, the critical path should be red. Use drawio to draw the tree view. Store it in `docs/assets/implementation-path.drawio.png` The link should be `![Implementation path](./assets/implementation-path.drawio.png)`
