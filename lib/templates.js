...
| Directory | Role |
|-----------|------|
| \`.ai/\` | Source of truth generated from selected \`src/\` items |
...
5. **Generation** – copies selected files into \`.ai/\`, then compiles \`.github/\` from \`.ai/\`.
